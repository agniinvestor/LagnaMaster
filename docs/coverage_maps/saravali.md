# Saravali — Coverage Map

**Author:** Kalyana Varma (c. 10th century CE)
**Chapters:** 68 (some editions count 80 with sub-chapters)
**School:** Parashari | **System:** natal | **Phase:** 1B_matrix + 1B_compound
**Rule ID prefix:** SAV001–SAV4200 (estimated)
**Target:** ~4,100–4,200 sutra-level rules

---

## Chapter Inventory & Section Map

### Block A: Conjunctions (S273–S280, ~1,040 rules)

Two-planet conjunctions are Saravali's most distinctive content vs. BPHS.
Each conjunction = 2 planets × multiple houses/outcomes = multiple rules.
...
Each planet placed in each of 12 signs with multiple stated outcomes.
...
Each planet placed in each of 12 houses (bhava) with outcomes.
