...
_MEAN_MOTION = {"Sun":0.9856,"Moon":13.1764,"Mars":0.5240,"Mercury":1.3833,
...
def compute_ishta_kashta(chart) -> dict[str, IshtaKashta]:
    ...
    for planet in ["Sun","Moon","Mars","Mercury","Jupiter","Venus","Saturn"]:
        ...
        result[planet] = IshtaKashta(
            planet=planet, uchcha_bala=round(ub, 3),
            cheshta_bala=round(cb, 3), ishta=ishta,
            kashta=kashta, net_sphuta=round(ishta - kashta, 3),
        )
    return result
