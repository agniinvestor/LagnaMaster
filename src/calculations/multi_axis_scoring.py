...
_WEIGHTS = {
    "parashari": {
        "R01":0.5,"R02":1.0,"R03":0.75,"R04":2.0,"R05":0.5,"R06":1.0,
        "R07":0.5,"R08":0.75,"R09":-1.0,"R10":-0.5,"R11":-1.25,"R12":-0.75,
        "R13":-0.5,"R14":-0.5,"R15":-2.0,"R16":-0.75,"R17":0.5,"R18":-0.5,
        "R19":-1.0,"R20":0.25,"R21":0.5,"R22":0.25,"R23":0.5,
    },
    "kp": {
        "R01":0.5,"R02":1.0,"R03":0.5,"R04":1.5,"R05":0.5,"R06":1.0,
        "R07":0.5,"R08":0.75,"R09":-1.0,"R10":-0.5,"R11":-1.25,"R12":-0.75,
        "R13":-0.5,"R14":-0.5,"R15":-1.75,"R16":-0.75,"R17":0.5,"R18":-0.5,
        "R19":-1.0,"R20":0.5,"R21":0.5,"R22":0.25,"R23":0.25,
    },
    "jaimini": {
        "R01":0.5,"R02":1.0,"R03":0.75,"R04":1.5,"R05":0.5,"R06":1.0,
        "R07":0.5,"R08":0.5,"R09":-1.0,"R10":-0.5,"R11":-1.0,"R12":-0.5,
        "R13":-0.5,"R14":-0.5,"R15":-2.0,"R16":-0.75,"R17":0.75,"R18":-0.75,
        "R19":-1.0,"R20":0.25,"R21":0.25,"R22":0.25,"R23":0.5,
    },
}
...
_TRIKONA = {1,5,9}
_DUSTHANA = {6,8,12}
_DIG_BALA = {"Sun":10,"Mars":10,"Moon":4,"Venus":4,"Mercury":1,"Jupiter":1,"Saturn":7}
...
def _kartari(house_si: int, sign_planets: dict) -> tuple[bool,bool]:
    ...
    shubh = (any(p in _NAT_BENEFIC for p in prev_pl) and
             any(p in _NAT_BENEFIC for p in next_pl))
    paap  = (any(p in _NAT_MALEFIC for p in prev_pl) and
             any(p in _NAT_MALEFIC for p in next_pl))
    return shubh, paap
...
class MultiAxisScores:
    ...
    def composite(self, house: int) -> float:
        ...
        return (self.d1.scores[house] * 0.5 +
...
def score_axis(chart, frame_lagna_si: int, axis_name: str, school: str = "parashari") -> AxisScores:
    ...
    for h in range(1, 13):
        scores[h] = _score_one_house(
            h, frame_lagna_si, chart, school, av_bindus,
            yogakaraka, dusthana_lords, kendra_lords, trikona_lords,
            is_fb, is_fm,
        )
