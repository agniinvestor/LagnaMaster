...
_COMPATIBILITY: dict[str, dict[str, JagradadiAvastha]] = {
    "fire": {
        "fire": JagradadiAvastha.JAGRAT,
        "air": JagradadiAvastha.SVAPNA,
        "earth": JagradadiAvastha.SUSHUPTI,
        "water": JagradadiAvastha.SUSHUPTI,
    },
    "earth": {
        "earth": JagradadiAvastha.JAGRAT,
        "water": JagradadiAvastha.SVAPNA,
        "fire": JagradadiAvastha.SUSHUPTI,
        "air": JagradadiAvastha.SUSHUPTI,
    },
    "air": {
        "air": JagradadiAvastha.JAGRAT,
        "fire": JagradadiAvastha.SVAPNA,
        "water": JagradadiAvastha.SUSHUPTI,
        "earth": JagradadiAvastha.SUSHUPTI,
    },
    "water": {
        "water": JagradadiAvastha.JAGRAT,
        "earth": JagradadiAvastha.SVAPNA,
        "air": JagradadiAvastha.SUSHUPTI,
        "fire": JagradadiAvastha.SUSHUPTI,
    },
    "ether": {
