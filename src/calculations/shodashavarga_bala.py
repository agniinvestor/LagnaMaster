...
def compute_shodashavarga_bala(planet: str, chart) -> dict:
    ...
    try:
        ...
        from src.calculations.dignity import compute_dignity_for_sign, DignityLevel  # noqa: F401
    except ImportError:
        return {
            "total_virupas": 0.0,
            "max_possible": 0.0,
...
def shodashavarga_summary(chart) -> dict[str, dict]:
    ...
    return {
        p: compute_shodashavarga_bala(p, chart) for p in planets if p in chart.planets
    }
