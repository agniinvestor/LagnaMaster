...
_DISCLAIMERS = {
    "career": (
        "This is reflective guidance inspired by Jyotish principles. "
    ...
    "health_longevity": (
        "This is reflective guidance only. It is not medical advice. "
    ...
    "mind_psychology": (
        "This is reflective guidance only. "
        "For mental health support, please speak with a qualified professional."
    ),
    "spirituality": (
        "This guidance is offered in the spirit of Jyotish as self-understanding. "
...
def should_show_dependency_nudge(
    session_count_today: int, session_count_week: int
) -> bool:
