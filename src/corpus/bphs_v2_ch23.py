...
b.add(conditions=[{"type": "planet_in_house", "planet": "any_benefic", "house": 12},
      ...
      verse_ref="Ch.23 v.10", commentary_context="Santhanam: Benefic exalted in 12th = moksha. The 12th house of liberation supported by strong benefics channels the soul toward spiritual release.", description="Benefic in 12th exalted or conjunct/aspected by benefic: one will attain final emancipation (moksha).",
      concordance_texts=["Saravali"],
