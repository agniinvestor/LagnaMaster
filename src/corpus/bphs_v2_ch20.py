...
b.add(conditions=[{"type": "planet_dignity", "planet": "lord_of_9", "dignity": "debilitated"}],
      ...
      direction="unfavorable", intensity="moderate", primary_domain="wealth",
...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 1, "house": 9},
      ...
      predictions=[{"entity": "father", "claim": "mutual_enmity_with_father", "domain": "character", "direction": "unfavorable", "magnitude": 0.6}],
...
b.add(
    ...
    direction="favorable", intensity="strong", primary_domain="career",
    predictions=[
        {"entity": "native", "claim": "virtuous_dear_to_king", "domain": "career", "direction": "favorable", "magnitude": 0.7},
        {"entity": "father", "claim": "native_devoted_to_father", "domain": "character", "direction": "favorable", "magnitude": 0.6},
    ],
...
b.add(
    ...
    direction="unfavorable", intensity="strong", primary_domain="wealth",
