...
_RULES = [
    RuleRecord("JP001", "JatakaParijata", "Ch.6 v.1", "parashari", "yoga",
    ...
    RuleRecord("JP002", "JatakaParijata", "Ch.6 v.5", "parashari", "yoga",
    ...
    RuleRecord("JP003", "JatakaParijata", "Ch.6 v.8", "parashari", "yoga",
    ...
    RuleRecord("JP004", "JatakaParijata", "Ch.7 v.1", "parashari", "dignity",
    ...
    RuleRecord("JP005", "JatakaParijata", "Ch.7 v.6", "parashari", "dignity",
    ...
    RuleRecord("JP006", "JatakaParijata", "Ch.8 v.2", "parashari", "house_quality",
    ...
    RuleRecord("JP007", "JatakaParijata", "Ch.8 v.5", "parashari", "house_quality",
    ...
    RuleRecord("JP008", "JatakaParijata", "Ch.9 v.1", "parashari", "yoga",
    ...
    RuleRecord("JP009", "JatakaParijata", "Ch.9 v.8", "parashari", "house_quality",
    ...
    RuleRecord("JP010", "JatakaParijata", "Ch.10 v.1", "parashari", "yoga",
    ...
    RuleRecord("JP011", "JatakaParijata", "Ch.10 v.4", "parashari", "yoga",
    ...
    RuleRecord("JP012", "JatakaParijata", "Ch.11 v.2", "parashari", "timing",
    ...
    RuleRecord("JP013", "JatakaParijata", "Ch.12 v.1", "parashari", "special",
    ...
    RuleRecord("JP014", "JatakaParijata", "Ch.13 v.1", "jaimini", "karak",
    ...
    RuleRecord("JP015", "JatakaParijata", "Ch.14 v.3", "parashari", "house_quality",
    ...
    RuleRecord("JP016", "JatakaParijata", "Ch.15 v.1", "parashari", "house_quality",
    ...
    RuleRecord("JP017", "JatakaParijata", "Ch.16 v.2", "parashari", "yoga",
