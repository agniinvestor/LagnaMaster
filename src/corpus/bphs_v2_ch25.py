...
def _upa(upagraha: str, house: int, signal: str, direction: str,
         intensity: str, primary_domain: str, claim: str,
    ...
    b.add(
        ...
        predictions=[{"entity": "native", "claim": claim,
                       "domain": primary_domain, "direction": direction,
...
_upa("dhuma", 1, "valiant_short_tempered", "mixed", "moderate",
     "character", "valiant_beautiful_eyes_stupefied_unkind_wicked_short_tempered",
...
_upa("dhuma", 2, "sickly_wealthy", "mixed", "moderate",
     "wealth", "sickly_wealthy_royal_humiliation_dullwitted_eunuch",
...
_upa("dhuma", 3, "intelligent_bold", "favorable", "moderate",
     "character", "intelligent_bold_delighted_eloquent_wealthy",
...
_upa("dhuma", 4, "grieved_learned", "mixed", "moderate",
     "character", "grieved_by_female_giving_up_but_learned_all_sastras",
...
_upa("dhuma", 5, "limited_progeny", "unfavorable", "moderate",
     "progeny", "limited_progeny_devoid_wealth_eat_anything_bereft_friends_mantras",
...
_upa("dhuma", 6, "conquer_enemies", "favorable", "strong",
     "relationships", "strong_conquer_enemies_brilliant_famous_free_diseases",
...
_upa("dhuma", 7, "penniless_sensuous", "unfavorable", "moderate",
     "wealth", "penniless_sensuous_others_females_devoid_brilliance",
...
_upa("dhuma", 8, "bereft_courage", "mixed", "moderate",
     "character", "bereft_courage_enthusiastic_truthful_disagreeable_selfish",
...
_upa("dhuma", 9, "sons_fortunes", "favorable", "strong",
     "wealth", "sons_fortunes_rich_honourable_kind_religious_disposed_relatives",
...
_upa("dhuma", 10, "sons_intelligent", "favorable", "moderate",
     "wealth", "sons_fortunes_delighted_intelligent_happy_truthful",
...
_upa("dhuma", 11, "wealth_arts", "favorable", "moderate",
     "wealth", "wealth_grains_gold_beautiful_arts_modest_singing",
...
_upa("dhuma", 12, "morally_fallen", "unfavorable", "strong",
     "character", "morally_fallen_sinful_others_wives_vices_unkind_crafty",
...
_upa("vyatipata", 1, "troubled_miseries", "unfavorable", "moderate",
     "character", "troubled_miseries_cruel_destructive_foolish_ill_disposed_relatives",
...
_upa("vyatipata", 2, "morally_crooked", "unfavorable", "moderate",
     "character", "morally_crooked_bilious_enjoy_pleasures_unkind_grateful_wicked",
...
_upa("vyatipata", 3, "warrior_rich", "favorable", "strong",
     "career", "firm_disposition_warrior_liberal_very_rich_dear_king_head_army",
...
_upa("vyatipata", 5, "poor_charming", "unfavorable", "moderate",
     "wealth", "poor_charming_imbalances_phlegm_bile_wind_hard_hearted_shameless",
...
_upa("vyatipata", 6, "overcome_enemies", "favorable", "strong",
     "relationships", "overcome_enemies_physically_mighty_skilful_weapons_arts_peaceful",
...
_upa("vyatipata", 7, "bereft_wealth", "unfavorable", "strong",
     "wealth", "bereft_wealth_wife_sons_subdue_females_miserable_sensuous_shameless",
...
_upa("vyatipata", 8, "deformity_eyes", "unfavorable", "strong",
     "health", "deformity_eyes_ugly_unfortunate_spiteful_brahmins_blood_disorders",
...
_upa("vyatipata", 9, "many_friends", "favorable", "moderate",
     "wealth", "many_business_friends_very_learned_well_disposed_wife_eloquent",
...
_upa("vyatipata", 10, "rich_religious", "favorable", "strong",
     "career", "rich_religious_peaceful_skilful_religious_acts_learned_farsighted",
...
_upa("vyatipata", 12, "anger_disabled", "unfavorable", "moderate",
     "character", "anger_many_activities_disabled_irreligious_hate_own_relatives",
...
_upa("paridhi", 1, "learned_peaceful", "favorable", "strong",
     "character", "learned_truthful_peaceful_rich_sons_pure_charitable_dear_elders",
...
_upa("paridhi", 2, "wealthy_religious", "favorable", "moderate",
     "wealth", "wealthy_charming_happy_very_religious_be_a_lord",
...
_upa("paridhi", 3, "fond_wife_pious", "favorable", "moderate",
     "relationships", "fond_wife_charming_pious_well_disposed_men_servant_respectful",
...
_upa("paridhi", 4, "wonderstruck_kind", "favorable", "moderate",
     "character", "wonderstruck_helpful_enemies_kind_endowed_everything_singing",
...
_upa("paridhi", 5, "affluent_virtuous", "favorable", "strong",
     "wealth", "affluent_virtuous_splendorous_affectionate_religious_dear_wife",
...
_upa("paridhi", 6, "famous_conquer", "favorable", "strong",
     "wealth", "famous_wealthy_sons_pleasures_helpful_all_conquer_enemies",
...
_upa("paridhi", 7, "limited_children", "unfavorable", "moderate",
     "progeny", "limited_children_devoid_happiness_mediocre_intelligence_sickly_wife",
...
_upa("paridhi", 10, "versed_arts", "favorable", "moderate",
     "career", "versed_arts_enjoy_pleasures_strong_bodied_learned_all_sastras",
...
_upa("paridhi", 11, "pleasures_women", "mixed", "moderate",
     "character", "pleasures_through_women_virtuous_intelligent_digestive_fire_disorders",
...
_upa("chapa", 2, "speak_affably", "favorable", "moderate",
     "wealth", "speak_affably_very_rich_modest_learned_charming_religious",
...
_upa("chapa", 3, "miser_thieving", "unfavorable", "moderate",
     "character", "miser_versed_many_arts_thieving_devoid_limb_unfriendly",
...
_upa("chapa", 4, "happy_honoured", "favorable", "moderate",
     "wealth", "happy_quadrupeds_wealth_grains_honoured_king_devoid_sickness",
...
_upa("chapa", 5, "splendorous_pious", "favorable", "moderate",
     "character", "splendorous_farsighted_pious_affable_prosperity_all_undertakings",
...
_upa("chapa", 6, "overcome_enemies_pure", "favorable", "strong",
     "relationships", "overcome_enemies_happy_affectionate_pure_plentifulness_undertakings",
...
_upa("chapa", 8, "others_jobs_cruel", "unfavorable", "moderate",
     "character", "interested_others_jobs_cruel_others_wives_defective_limbed",
...
_upa("chapa", 9, "penance_famous", "favorable", "strong",
     "spirituality", "penance_religious_observations_highly_learned_famous",
...
_upa("chapa", 10, "many_sons_wealth", "favorable", "strong",
     "wealth", "many_sons_abundant_wealth_cows_buffaloes_famous",
...
_upa("chapa", 11, "gainful_mantras", "favorable", "strong",
     "wealth", "gainful_free_diseases_fiery_disposition_affectionate_wife_mantras_weapons",
...
_upa("chapa", 12, "wicked_poor", "unfavorable", "strong",
     "character", "wicked_honourable_evil_disposition_shameless_others_females_poor",
...
_upa("dhwaja", 1, "skilful_learning", "favorable", "moderate",
     "character", "skilful_all_learning_happy_efficient_speech_agreeable_affectionate",
...
_upa("dhwaja", 2, "good_speaker_poetry", "favorable", "moderate",
     "character", "good_speaker_splendorous_write_poetry_scholarly_conveyances",
...
_upa("dhwaja", 3, "miserly_poor", "unfavorable", "moderate",
     "wealth", "miserly_cruel_acts_thin_bodied_poor_severe_diseases",
...
_upa("dhwaja", 4, "charming_vedas", "favorable", "moderate",
     "character", "charming_very_virtuous_gentle_interested_vedas_always_happy",
...
_upa("dhwaja", 5, "happy_pleasures", "favorable", "moderate",
     "career", "happy_enjoy_pleasures_versed_arts_skilled_expedients_intelligent_eloquent",
...
_upa("dhwaja", 6, "win_enemies_valiant", "favorable", "moderate",
     "relationships", "ominous_maternal_relatives_win_enemies_many_relatives_valiant_skilful",
...
_upa("dhwaja", 7, "gambling_sensuous", "unfavorable", "moderate",
     "character", "interested_gambling_sensuous_enjoy_pleasures_befriend_prostitutes",
...
_upa("dhwaja", 8, "sinful_shameless", "unfavorable", "moderate",
     "character", "base_acts_sinful_shameless_blame_others_lack_marital_happiness",
...
_upa("dhwaja", 10, "happiness_fortunes", "favorable", "moderate",
     "wealth", "happiness_fortunes_fond_females_charitable_befriend_brahmins",
...
_upa("dhwaja", 11, "ever_acquire_gains", "favorable", "strong",
     "wealth", "ever_acquire_gains_very_religious_honourable_affluent_valiant_sacrificial",
...
_upa("dhwaja", 12, "sinful_untrustworthy", "unfavorable", "moderate",
     "character", "sinful_acts_valiant_untrustworthy_unkind_others_females_short_tempered",
...
_upa("gulika", 1, "afflicted_diseases", "unfavorable", "strong",
     "health", "afflicted_diseases_lustful_sinful_crafty_wicked_miserable",
...
_upa("gulika", 2, "unsightly_penniless", "unfavorable", "strong",
     "wealth", "unsightly_miserable_given_vices_shameless_penniless",
...
_upa("gulika", 3, "charming_head_village", "favorable", "moderate",
     "career", "charming_head_village_fond_virtuous_men_honoured_by_king",
...
_upa("gulika", 4, "sickly_sinful", "unfavorable", "strong",
     "health", "sickly_devoid_happiness_sinful_afflicted_windy_bilious_excesses",
...
_upa("gulika", 5, "not_praiseworthy", "unfavorable", "strong",
     "progeny", "not_praiseworthy_poor_short_lived_spiteful_mean_eunuch_subdued_wife",
...
_upa("gulika", 8, "troubled_hunger", "unfavorable", "strong",
     "wealth", "troubled_hunger_miserable_cruel_short_tempered_unkind_poor",
...
_upa("gulika", 9, "undergo_ordeals", "unfavorable", "strong",
     "character", "undergo_ordeals_emaciated_evil_acts_very_unkind_sluggish_talebearer",
...
_upa("gulika", 10, "endowed_sons_happy", "favorable", "moderate",
     "progeny", "endowed_sons_happy_enjoy_many_things_worship_gods_fire_meditation",
...
_upa("gulika", 11, "enjoy_women_leader", "mixed", "moderate",
     "wealth", "enjoy_women_class_leader_men_helpful_relatives_short_emperor",
...
_upa("gulika", 12, "base_deeds_sinful", "unfavorable", "strong",
     "character", "indulge_base_deeds_sinful_defective_limbed_unfortunate_indolent_mean_people",
...
_upa("pranapada", 1, "weak_sickly", "unfavorable", "strong",
     "health", "weak_sickly_dullwitted_defective_limbed_miserable_emaciated",
...
_upa("pranapada", 3, "injurious_proud", "unfavorable", "moderate",
     "character", "injurious_mischievous_proud_hard_hearted_dirty_no_respect_elders",
...
_upa("pranapada", 4, "happy_truthful", "favorable", "moderate",
     "character", "happy_attached_females_elders_soft_truthful",
...
_upa("pranapada", 5, "good_acts_kind", "favorable", "moderate",
     "character", "happy_do_good_acts_kind_very_affectionate",
...
_upa("pranapada", 6, "subdued_sickly", "unfavorable", "moderate",
     "health", "subdued_relatives_enemies_sharp_defective_digestive_fire_sickly_shortlived",
...
_upa("pranapada", 7, "green_eyed_fierce", "unfavorable", "moderate",
     "character", "green_eyed_ever_libidinous_fierce_appearance_not_worth_respect",
...
_upa("pranapada", 8, "afflicted_diseases_misery", "unfavorable", "strong",
     "health", "afflicted_diseases_troubled_incur_misery_king_relatives_servants_sons",
...
_upa("pranapada", 9, "endowed_sons_rich", "favorable", "strong",
     "wealth", "endowed_sons_very_rich_fortunate_charming_serve_others_skilful",
...
_upa("pranapada", 10, "heroic_intelligent", "favorable", "strong",
     "career", "heroic_intelligent_skilful_expert_royal_orders_worship_gods",
...
_upa("pranapada", 11, "famous_learned", "favorable", "strong",
     "wealth", "famous_virtuous_learned_wealthy_fair_complexioned_attached_mother",
...
_upa("pranapada", 12, "mean_defective", "unfavorable", "strong",
     "health", "mean_wicked_defective_limbed_hate_brahmins_relatives_eye_diseases",
