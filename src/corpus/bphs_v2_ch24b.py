...
b.add(
    ...
    predictions=[
        {"entity": "native", "claim": "scholarly_progenic_happiness_but_miser_crooked_steal_others_wealth",
         "domain": "intelligence_education", "direction": "mixed", "magnitude": 0.5},
    ],
...
b.add(
    ...
    domains=["progeny", "fame_reputation"],
    predictions=[
...
b.add(
    ...
    predictions=[
        {"entity": "native", "claim": "attached_coborn_talebearer_miser_interested_own_work",
         "domain": "character_temperament", "direction": "mixed", "magnitude": 0.5},
    ],
...
b.add(
    ...
    direction="favorable", intensity="strong",
    domains=["intelligence_education", "property_vehicles"],
    predictions=[
...
b.add(
    ...
    direction="favorable", intensity="moderate",
    domains=["progeny", "character_temperament"],
    predictions=[
...
b.add(
    ...
    direction="unfavorable", intensity="strong",
    domains=["progeny", "physical_health"],
    predictions=[
...
b.add(
    ...
    direction="favorable", intensity="strong",
    domains=["fame_reputation", "intelligence_education"],
    predictions=[
...
b.add(
    ...
    predictions=[
        {"entity": "native", "claim": "rajayoga_various_pleasures_very_famous",
         "domain": "career_status", "direction": "favorable", "magnitude": 0.8},
    ],
...
b.add(
    ...
    direction="favorable", intensity="strong",
    domains=["intelligence_education", "progeny"],
    predictions=[
...
b.add(
    ...
    direction="mixed", intensity="moderate",
    domains=["physical_health", "fame_reputation"],
    predictions=[
        {"entity": "native", "claim": "sickly_famous_inimical_to_own_men_rich_honourable_adventurous",
         "domain": "physical_health", "direction": "mixed", "magnitude": 0.5},
    ],
...
b.add(
    ...
    direction="favorable", intensity="moderate",
    domains=["foreign_travel", "character_temperament"],
    predictions=[
        {"entity": "native", "claim": "adventurous_famous_live_alien_countries_skilful_speaker",
         "domain": "foreign_travel", "direction": "favorable", "magnitude": 0.6},
    ],
...
b.add(
    ...
    direction="unfavorable", intensity="moderate",
    domains=["enemies_litigation", "character_temperament"],
    predictions=[
...
b.add(
    ...
    direction="mixed", intensity="moderate",
    domains=["property_vehicles", "wealth"],
    predictions=[
        {"entity": "native", "claim": "devoid_maternal_happiness_intelligent_talebearer_jealous_very_rich",
         "domain": "property_vehicles", "direction": "mixed", "magnitude": 0.5},
    ],
...
b.add(
    ...
    direction="mixed", intensity="moderate",
    domains=["enemies_litigation", "physical_health"],
    predictions=[
        {"entity": "native", "claim": "enmity_with_kinsmen_friendly_to_others_mediocre_wealth",
         "domain": "enemies_litigation", "direction": "mixed", "magnitude": 0.5},
...
b.add(
    ...
    predictions=[
        {"entity": "native", "claim": "trade_in_wood_stones_or_poison_fluctuating_professional_fortunes",
         "domain": "career_status", "direction": "mixed", "magnitude": 0.5},
    ],
...
b.add(
    ...
    predictions=[
        {"entity": "native", "claim": "spend_on_vices_hostile_learned_people_torture_living_beings",
         "domain": "character_temperament", "direction": "unfavorable", "magnitude": 0.7},
    ],
...
b.add(
    ...
    predictions=[
        {"entity": "native", "claim": "happiness_through_wife_courageous_skilful_intelligent",
         "domain": "marriage", "direction": "favorable", "magnitude": 0.7},
    ],
...
b.add(
    ...
    predictions=[
        {"entity": "native", "claim": "union_many_women_well_disposed_own_wife_many_undertakings",
         "domain": "marriage", "direction": "favorable", "magnitude": 0.6},
    ],
...
b.add(
    ...
    direction="unfavorable", intensity="moderate",
    domains=["wealth", "physical_health"],
    predictions=[
...
b.add(
    ...
    direction="unfavorable", intensity="strong",
    domains=["property_vehicles", "longevity"],
    entity_target="general",
    predictions=[
        {"entity": "native", "claim": "deprived_of_mother_early_devoid_house_lands_happiness_betray_friends",
         "domain": "property_vehicles", "direction": "unfavorable", "magnitude": 0.7},
...
b.add(
    ...
    direction="mixed", intensity="moderate",
    domains=["intelligence_education", "longevity"],
    predictions=[
...
b.add(
    ...
    direction="mixed", intensity="moderate",
    domains=["enemies_litigation", "longevity"],
    predictions=[
...
b.add(
    ...
    predictions=[
        {"entity": "native", "claim": "devoid_paternal_bliss_talebearer_bereft_livelihood",
         "domain": "career_status", "direction": "unfavorable", "magnitude": 0.6},
    ],
...
b.add(
    ...
    direction="unfavorable", intensity="strong",
    domains=["longevity", "character_temperament"],
    predictions=[
