...
b.add(conditions=[{"type": "planet_dignity", "planet": "lord_of_10", "dignity": "strong"}],
      ...
      predictions=[{"entity": "native", "claim": "paternal_happiness_fame_good_deeds", "domain": "career", "direction": "favorable", "magnitude": 0.8}],
      verse_ref="Ch.21 v.2",
...
b.add(conditions=[{"type": "planet_dignity", "planet": "lord_of_10", "dignity": "weak"}],
      ...
      primary_domain="career",
      predictions=[{"entity": "native", "claim": "obstructions_in_professional_work", "domain": "career", "direction": "unfavorable", "magnitude": 0.7}],
...
b.add(conditions=[
      ...
      primary_domain="career",
      predictions=[{"entity": "native", "claim": "always_gain_through_royal_patronage_and_business", "domain": "career", "direction": "favorable", "magnitude": 0.7}],
      verse_ref="Ch.21 v.4",
      commentary_context=(
...
b.add(conditions=[{"type": "planet_in_house", "planet": "any_malefic", "house": 10},
      ...
      predictions=[{"entity": "native", "claim": "indulge_in_bad_deeds_defile_own_men", "domain": "character", "direction": "unfavorable", "magnitude": 0.6}],
      verse_ref="Ch.21 v.5",
...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 10, "house": 8},
      ...
      primary_domain="character",
      predictions=[{"entity": "native", "claim": "great_fool_bad_deeds_hate_others", "domain": "character", "direction": "unfavorable", "magnitude": 0.7}],
      verse_ref="Ch.21 v.6",
...
b.add(conditions=[
      ...
      primary_domain="character",
      predictions=[{"entity": "native", "claim": "fond_of_carnal_pleasures_and_filling_belly", "domain": "character", "direction": "unfavorable", "magnitude": 0.5}],
      verse_ref="Ch.21 v.7",
      commentary_context=(
...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 10, "house": [1, 4, 5, 7, 9, 10]},
      ...
      primary_domain="career",
      predictions=[
          {"entity": "native", "claim": "endowed_with_honour_wealth_and_valour", "domain": "career", "direction": "favorable", "magnitude": 0.8},
...
b.add(conditions=[
      ...
      primary_domain="career",
      predictions=[{"entity": "native", "claim": "cessation_of_duties_no_happy_calling", "domain": "career", "direction": "unfavorable", "magnitude": 0.7}],
...
b.add(conditions=[{"type": "planet_in_house", "planet": "Jupiter", "house": 12}],
      ...
      primary_domain="character",
      predictions=[
          {"entity": "native", "claim": "learned_and_wealthy_gnana_yoga", "domain": "character", "direction": "favorable", "magnitude": 0.8},
...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 10, "house": [1, 4, 5, 7, 9, 10]},
      ...
      primary_domain="character",
      predictions=[{"entity": "native", "claim": "endowed_with_worthy_deeds", "domain": "character", "direction": "favorable", "magnitude": 0.7}],
...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 10, "house": 1}],
      ...
      primary_domain="character",
      predictions=[{"entity": "native", "claim": "interested_in_good_deeds", "domain": "character", "direction": "favorable", "magnitude": 0.6}],
...
b.add(conditions=[{"type": "planet_in_house", "planet": "Saturn", "house": 10}],
      ...
      primary_domain="character",
      predictions=[{"entity": "native", "claim": "bereft_of_virtuous_acts", "domain": "character", "direction": "unfavorable", "magnitude": 0.6}],
...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 10, "house": 8},
      ...
      primary_domain="character",
      predictions=[{"entity": "native", "claim": "indulge_in_bad_acts_career_scandals", "domain": "character", "direction": "unfavorable", "magnitude": 0.7}],
...
b.add(conditions=[{"type": "planet_dignity", "planet": "lord_of_10", "dignity": "debilitated"}],
      ...
      primary_domain="career",
      predictions=[{"entity": "native", "claim": "obstructions_career_completely_blocked", "domain": "career", "direction": "unfavorable", "magnitude": 0.7}],
...
b.add(conditions=[{"type": "planet_in_house", "planet": "Moon", "house": 10},
      ...
      primary_domain="career",
      predictions=[{"entity": "native", "claim": "endowed_with_fame_public_visibility", "domain": "career", "direction": "favorable", "magnitude": 0.7}],
...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 11, "house": 10}],
      ...
      primary_domain="career",
      predictions=[{"entity": "native", "claim": "fame_through_professional_achievement", "domain": "career", "direction": "favorable", "magnitude": 0.7}],
...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 10, "house": 9},
      ...
      primary_domain="career",
      predictions=[{"entity": "native", "claim": "fame_through_dharma_karma_connection", "domain": "career", "direction": "favorable", "magnitude": 0.7}],
