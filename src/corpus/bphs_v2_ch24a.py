...
b.add(
    ...
    domains=["wealth", "intelligence_education"],
    predictions=[
...
b.add(
    ...
    direction="favorable", intensity="moderate",
    domains=["character_temperament", "fame_reputation"],
    predictions=[
...
b.add(
    ...
    domains=["physical_health", "enemies_litigation"],
    predictions=[
...
b.add(
    ...
    predictions=[
        {"entity": "native", "claim": "alternatively_become_king_if_planet_strong",
         "domain": "career_status", "direction": "favorable", "magnitude": 0.7},
    ],
    verse_ref="Ch.24 v.7",
...
b.add(
    ...
    direction="mixed", intensity="moderate",
    domains=["intelligence_education", "physical_health"],
    predictions=[
        {"entity": "native", "claim": "accomplished_scholar_but_sickly_thievish_gambler",
         "domain": "intelligence_education", "direction": "favorable", "magnitude": 0.5},
...
b.add(
    ...
    predictions=[
        {"entity": "native", "claim": "aries_libra_evil_results_moderated_scan_further",
         "domain": "physical_health", "direction": "mixed", "magnitude": 0.4},
    ],
    verse_ref="Ch.24 v.8",
...
b.add(
    ...
    direction="favorable", intensity="strong",
    domains=["wealth", "fame_reputation"],
    predictions=[
...
b.add(
    ...
    direction="unfavorable", intensity="moderate",
    domains=["physical_health", "wealth"],
    predictions=[
...
b.add(
    ...
    direction="mixed", intensity="moderate",
    domains=["character_temperament", "wealth"],
    predictions=[
...
b.add(
    ...
    direction="unfavorable", intensity="moderate",
    domains=["enemies_litigation", "wealth"],
    predictions=[
...
b.add(
    ...
    direction="unfavorable", intensity="strong",
    domains=["career_status", "character_temperament"],
    predictions=[
        {"entity": "native", "claim": "thief_derive_livelihood_serving_others_die_at_royal_gate",
         "domain": "career_status", "direction": "unfavorable", "magnitude": 0.7},
    ],
...
b.add(
    ...
    direction="unfavorable", intensity="strong",
    domains=["property_vehicles", "progeny"],
    predictions=[
...
b.add(
    ...
    direction="unfavorable", intensity="strong",
    domains=["property_vehicles", "character_temperament"],
    predictions=[
