...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 11, "house": [1, 4, 5, 7, 9, 10, 11]}],
      signal_group="h11_lord_kendra_gains", direction="favorable", intensity="strong", primary_domain="wealth",
      ...
      exceptions=["exaltation_overrides_combustion_for_gains"])

b.add(conditions=[{"type": "lord_in_house", "lord_of": 11, "house": 3},
                   {"type": "planet_in_house", "planet": "any_benefic", "house": 11}],
      signal_group="h11_lord_h3_2000_nishkas_36", direction="favorable", intensity="moderate", primary_domain="wealth",
...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 11, "house": [1, 4, 5, 7, 9, 10]},
                   {"type": "planets_conjunct", "planets": ["lord_of_11", "any_benefic"]}],
      signal_group="h11_lord_kendra_500_nishkas_40", direction="favorable", intensity="moderate", primary_domain="wealth",
...
b.add(conditions=[{"type": "planet_in_house", "planet": "Jupiter", "house": 11},
                   {"type": "planet_in_house", "planet": "Moon", "house": 2},
                   {"type": "planet_in_house", "planet": "Venus", "house": 9}],
      signal_group="jupiter_h11_6000_nishkas", direction="favorable", intensity="strong", primary_domain="wealth",
...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 11, "house": 1},
      ...
      signal_group="h11_h1_exchange_1000_nishkas_33", direction="favorable", intensity="strong", primary_domain="wealth",
...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 11, "house": 2},
      ...
      signal_group="h11_h2_exchange_after_marriage", direction="favorable", intensity="moderate", primary_domain="wealth",
...
b.add(conditions=[{"type": "lord_in_house", "lord_of": 11, "house": [6, 8, 12]},
                   {"type": "planets_conjunct", "planets": ["lord_of_11", "any_malefic"]}],
      signal_group="h11_lord_dusthana_no_gains", direction="unfavorable", intensity="strong", primary_domain="wealth",
