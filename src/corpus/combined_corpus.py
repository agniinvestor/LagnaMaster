...
def build_corpus() -> CorpusRegistry:
    ...
    # V2 = verse layer (canonical). V1 = derived layer (interpretive).
    # Both are valid knowledge at different authority levels.
    # See src/corpus/migration_registry.py for the system philosophy.
