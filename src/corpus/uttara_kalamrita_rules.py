...
_RULES = [
    RuleRecord("UK001", "UttaraKalamrita", "Ch.4 v.1", "parashari", "special",
    ...
    RuleRecord("UK002", "UttaraKalamrita", "Ch.4 v.3", "parashari", "special",
    ...
    RuleRecord("UK003", "UttaraKalamrita", "Ch.4 v.5", "parashari", "house_quality",
    ...
    RuleRecord("UK004", "UttaraKalamrita", "Ch.5 v.1", "parashari", "timing",
    ...
    RuleRecord("UK005", "UttaraKalamrita", "Ch.5 v.8", "parashari", "timing",
    ...
    RuleRecord("UK006", "UttaraKalamrita", "Ch.2 v.1", "parashari", "special",
    ...
    RuleRecord("UK007", "UttaraKalamrita", "Ch.2 v.4", "parashari", "special",
    ...
    RuleRecord("UK008", "UttaraKalamrita", "Ch.3 v.1", "parashari", "house_quality",
    ...
    RuleRecord("UK009", "UttaraKalamrita", "Ch.6 v.2", "parashari", "dasha",
    ...
    RuleRecord("UK010", "UttaraKalamrita", "Ch.7 v.1", "parashari", "yoga",
    ...
    RuleRecord("UK011", "UttaraKalamrita", "Ch.7 v.3", "parashari", "yoga",
    ...
    RuleRecord("UK012", "UttaraKalamrita", "Ch.7 v.4", "parashari", "yoga",
    ...
    RuleRecord("UK013", "UttaraKalamrita", "Ch.7 v.5", "parashari", "yoga",
    ...
    RuleRecord("UK014", "UttaraKalamrita", "Ch.7 v.6", "parashari", "yoga",
    ...
    RuleRecord("UK015", "UttaraKalamrita", "Ch.7 v.2", "parashari", "yoga",
    ...
    RuleRecord("UK016", "UttaraKalamrita", "Ch.8 v.1", "parashari", "timing",
    ...
    RuleRecord("UK017", "UttaraKalamrita", "Ch.9 v.2", "parashari", "house_quality",
