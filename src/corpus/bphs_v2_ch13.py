...
def _build_rules() -> list[RuleRecord]:
    """Build all V2 Ch.13 rules."""
    rules: list[RuleRecord] = []
    num = 1300  # BPHS1300+ for V2 Ch.13
    ...
    def _add(*, conditions, entity_target, signal_group, direction, intensity,
        ...
        all_tags = list(dict.fromkeys(
            ["bphs", "parashari", "2nd_house", "dhana_bhava"] + (tags or [])
        ))

        rules.append(RuleRecord(
            rule_id=rid, source="BPHS", chapter="Ch.13", school="parashari",
            category="2nd_house_effects",
            description=f"[BPHS — 2nd_house_effects] {description}",
    ...
    _add(
        ...
        entity_target="native", signal_group="h2_lord_kendra_wealth",
    ...
    _add(
        ...
        entity_target="native", signal_group="h2_lord_dusthana_poverty",
    ...
    _add(
        ...
        entity_target="native", signal_group="benefic_h2_wealth",
    ...
    _add(
        ...
        entity_target="native", signal_group="malefic_h2_poverty",
        direction="unfavorable", intensity="moderate",
        domains=["wealth"],
        predictions=[
    ...
    _add(
        ...
        entity_target="native", signal_group="jupiter_h2_wealth",
        direction="favorable", intensity="strong",
        domains=["wealth"],
        predictions=[
    ...
    _add(
        ...
        entity_target="native", signal_group="h2_h11_exchange_wealth",
        direction="favorable", intensity="strong",
        domains=["wealth"],
        predictions=[
    ...
    _add(
        ...
        entity_target="native", signal_group="h2_kendra_h11_trikona_wealth",
        direction="favorable", intensity="strong",
        domains=["wealth"],
        predictions=[
    ...
    _add(
        ...
        entity_target="native", signal_group="h2_lord_dusthana_penniless",
    ...
    _add(
        ...
        entity_target="native", signal_group="h2_lord_combust_begging",
        direction="unfavorable", intensity="strong",
        domains=["wealth"],
        predictions=[
    ...
    _add(
        ...
        entity_target="native", signal_group="h2_h11_government_loss",
        direction="unfavorable", intensity="strong",
    ...
    _add(
        ...
        entity_target="native", signal_group="jupiter_h11_venus_h2_charity",
        direction="favorable", intensity="moderate",
    ...
    _add(
        ...
        entity_target="native", signal_group="h2_lord_exalted_fame",
        direction="favorable", intensity="strong",
    ...
    _add(
        ...
        entity_target="native", signal_group="h2_lord_paravatamsa_wealth",
        direction="favorable", intensity="strong",
        domains=["wealth"],
        predictions=[
    ...
    _add(
        ...
        entity_target="native", signal_group="h2_lord_strong_eyes",
        direction="favorable", intensity="moderate",
    ...
    _add(
        ...
        entity_target="native", signal_group="h2_lord_dusthana_eye_disease",
        direction="unfavorable", intensity="moderate",
    ...
    _add(
        ...
        entity_target="native", signal_group="h2_malefic_untruthful",
        direction="unfavorable", intensity="moderate",
...
BPHS_V2_CH13_REGISTRY = CorpusRegistry()
for _rule in _build_rules():
    BPHS_V2_CH13_REGISTRY.add(_rule)
