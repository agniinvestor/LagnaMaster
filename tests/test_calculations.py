...
class TestNakshatra:
    def test_sun_ashlesha(self, india_chart):
        ...
        assert pos.nakshatra == "Ashlesha", f"Sun nakshatra: expected Ashlesha, got {pos.nakshatra}"
        assert pos.pada == 4
    ...
    def test_all_padas_1_to_4(self):
        from src.calculations.nakshatra import nakshatra_position, NAKSHATRA_SPAN
...
from src.calculations.dignity import DignityLevel as DignityLevel
class TestDignity:
    @staticmethod
    def _dig(planet, **kw):
        from src.calculations.dignity import compute_dignity_legacy as _cd, DignityLevel
...
class TestFriendship:
    def test_sun_moon_sama(self, india_chart):
        ...
        from src.calculations.friendship import compute_friendship
        r = compute_friendship("Sun", india_chart.planets["Sun"].sign_index,
                               "Moon", india_chart.planets["Moon"].sign_index)
    ...
    def test_mars_sun_adhi_mitra(self, india_chart):
        ...
        from src.calculations.friendship import compute_friendship
        r = compute_friendship("Mars", india_chart.planets["Mars"].sign_index,
                               "Sun",  india_chart.planets["Sun"].sign_index)
...
class TestCharaKarak:
    ...
    def test_degrees_descending(self, india_chart):
        ...
        assert degs == sorted(degs, reverse=True), "Karakas should be sorted descending by degree"
...
class TestNarayanaDasha:
    def test_n1_bug_fixed_taurus_7_years(self):
        ...
        from src.calculations.narayana_dasa import NARAYANA_DASHA_YEARS
    ...
    def test_total_cycle_81_years(self):
        ...
        assert total == 81, f"Total Narayana Dasha cycle should be 81 years, got {total}"
    ...
    def test_12_periods_returned(self, india_chart):
        from src.calculations.narayana_dasa import compute_narayana_dasha
        periods = compute_narayana_dasha(india_chart.lagna_sign_index, date(1947, 8, 15))
