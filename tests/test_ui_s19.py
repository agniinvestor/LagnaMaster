...
class TestImports:
    ...
    def test_varga_importable(self):
        from src.calculations.varga import compute_varga, varga_sign_name
...
class TestVargaTab:
    ...
    def test_varga_produces_all_8_divisions(self, india_chart):
        ...
        assert set(vc.tables.keys()) == {"D2","D3","D4","D7","D9","D10","D12","D60"}
...
class TestAnnualTab:
    ...
    def test_varshaphala_tajika_aspect_fields(self, india_chart):
        from src.calculations.varshaphala import compute_varshaphala, TajikaAspect
        vr = compute_varshaphala(
            natal_chart=india_chart,
            natal_birth_date=date(1947, 8, 15),
            target_year=1948,
