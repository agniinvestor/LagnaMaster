...
class TestFunctionalDignity:
    ...
    def test_lagna_lord_always_benefic(self):
        ...
        for lagna_si in range(12):
            ...
            # Find the lagna lord
            _SL = {0:"Mars",1:"Venus",2:"Mercury",3:"Moon",4:"Sun",5:"Mercury",
...
class TestPlanetAvasthas:
    ...
    def test_yuva_highest_modifier(self):
        ...
        assert BALA_AVASTHA_MODIFIER[BalaAvastha.YUVA] > BALA_AVASTHA_MODIFIER[BalaAvastha.BALA]
        assert BALA_AVASTHA_MODIFIER[BalaAvastha.YUVA] > BALA_AVASTHA_MODIFIER[BalaAvastha.MRITA]
...
class TestPanchadhyayeeMaitri:
    ...
    def test_adhimitra_sun_jupiter_friendly(self):
        ...
        chart = make_chart(0.0, Sun=0.0, Jupiter=30.0)  # Sun Aries, Jup Taurus (H2 from Sun)
    ...
    def test_shadbala_threshold_sun(self):
        from src.calculations.shadbala_patches import is_shadbala_strong, SHADBALA_MIN_VIRUPAS
...
class TestYogaStrength:
    ...
    def test_yoga_strength_with_exalted_planets(self):
        ...
        chart = make_chart(0.0, Sun=10.0, Jupiter=90.0,
                           Moon=50.0, Mars=200.0, Mercury=220.0,
                           Venus=300.0, Saturn=270.0, Rahu=40.0, Ketu=220.0)
    ...
    def test_amala_yoga_detection(self):
        ...
        chart = make_chart(0.0, Jupiter=285.0,  # Capricorn = H10 from Aries
                           Sun=10.0, Moon=50.0, Mars=200.0, Mercury=220.0,
                           Venus=300.0, Saturn=0.0, Rahu=40.0, Ketu=220.0)
    ...
    def test_mahabhagya_yoga_male(self):
        ...
        chart = make_chart(0.0,  # Aries Lagna (odd)
                           Sun=60.0,   # Gemini (odd)
                           Moon=120.0, # Leo (odd)
                           Mars=200.0, Mercury=220.0, Jupiter=150.0,
                           Venus=300.0, Saturn=270.0, Rahu=40.0, Ketu=220.0)
...
class TestDashaActivation:
    ...
    def test_ashtottari_when_rahu_not_in_kendra_trikona(self):
        ...
        chart = make_chart(0.0, Rahu=60.0, Ketu=240.0,
                           Sun=10.0, Moon=50.0, Mars=200.0,
                           Mercury=220.0, Jupiter=150.0, Venus=300.0, Saturn=270.0)
        result = compute_applicable_dashas(chart)
...
class TestKarakamsha:
    ...
    def test_karakamsha_returns_result(self):
        ...
        assert result.ishta_devata in ("Sun","Moon","Mars","Mercury","Jupiter","Venus","Saturn","Rahu","Ketu")
