...
class TestFeedbackLoop:
    def test_record_helpful(self, tmp_db):
        ...
        r = record_feedback(
            "u1", "chart1", "career", "helpful", "2026-03-20", db_path=tmp_db
        )
    ...
    def test_record_concerning_queued(self, tmp_db):
        ...
        r = record_feedback(
            "u1", "chart1", "health", "concerning", "2026-03-20", db_path=tmp_db
        )
    ...
    def test_invalid_rating(self, tmp_db):
        ...
        with pytest.raises(ValueError):
            record_feedback(
                "u1", "chart1", "career", "bad_rating", "2026-03-20", db_path=tmp_db
            )
...
class TestDependencyPrevention:
    def test_log_session(self, tmp_db):
        from src.feedback.dependency_prevention import (
            log_session,
