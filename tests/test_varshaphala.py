...
class TestReportStructure:
    ...
    def test_varsha_lagna_sign_consistent(self, report_1948):
        assert (
            report_1948.varsha_lagna_sign == _SIGNS[report_1948.varsha_lagna_sign_index]
        )
...
class TestSolarReturn2026:
    ...
    def test_determinism(self, india_chart):
        ...
        r1 = compute_varshaphala(india_chart, date(1947, 8, 15), 2026, 28.6139, 77.2090)
        r2 = compute_varshaphala(india_chart, date(1947, 8, 15), 2026, 28.6139, 77.2090)
