...
class TestMultiLagna:
    ...
    def test_karakamsha_returns_result(self, chart):
        ...
        assert kk.atmakaraka in ["Sun","Moon","Mars","Mercury","Jupiter","Venus","Saturn"]
...
class TestMultiAxisScoring:
    ...
    def test_composite_formula(self, chart):
        ...
        m = score_all_axes(chart)
        for h in range(1,13):
            expected = round(m.d1.scores[h]*0.5 + m.d9.scores[h]*0.3 + m.d10.scores[h]*0.2, 3)
...
class TestDivisionalCharts:
    def test_divisional_map_has_all_vargas(self, chart):
        ...
        expected_vargas = {"D1","D2","D3","D4","D7","D9","D10","D12","D16","D20","D24","D27","D30","D40","D45","D60"}
