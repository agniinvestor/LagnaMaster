...
**Strategy**: Pilot-first → accuracy iteration.
...
| Session | Deliverable | Status | Tests |
|---------|-------------|--------|-------|
| 11 | `pushkara.py` + `monte_carlo.py` | ✅ Done | 30 |
...
1947 India Independence Chart: 1947-08-15 00:00 IST, New Delhi (28.6139°N, 77.2090°E).
Lagna: 7.7286° Taurus. Ayanamsha: Lahiri. All modules validated against this fixture.
